...
function setImages() {
	...
	cardsymbolIndexArray.push(symbolIndexArray[i]);
    }
...
function symbolflip() {
if(flipcount == 2 && isclickable == 0)
	{
flipcount = 0;
isclickable = 1;
document.getElementById("flipbtn").src = "images/flip_over.png"
if(matchshape1 == matchshape2)
{
	if(currentplayer == 0){
		player1++
...
else
{
	...
	for(let i = 0; i < flipcards.length; i++){
        flip[flipcards[i]].style.transform = "rotateY(0deg)";
	}
	flipcards.length = 0;
}
